...
data.repeat.50<-RUN.baseline("./Data/Real_data/N50.xlsx")
data.repeat.40<-RUN("./Data/Real_data/N40.xlsx",data.repeat.50)
data.repeat.30<-RUN("./Data/Real_data/N30.xlsx",data.repeat.50)
data.repeat.20<-RUN("./Data/Real_data/N20.xlsx",data.repeat.50)
data.repeat.10<-RUN("./Data/Real_data/N10.xlsx",data.repeat.50)
```
